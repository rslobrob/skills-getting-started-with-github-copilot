...
activities = {
    ...
    "Basketball": {
        "description": "Competitive basketball games and skill development",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["alex@mergington.edu"]
    },
    "Soccer": {
        "description": "Soccer training and matches for all skill levels",
    ...
    "Music Ensemble": { 
        "description": "Join the school orchestra and perform classical music",
